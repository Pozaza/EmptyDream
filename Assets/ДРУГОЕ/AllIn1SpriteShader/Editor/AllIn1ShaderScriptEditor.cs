...
public class AllIn1ShaderScriptEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Texture2D imageInspector = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Project/External/AllIn1SpriteShader/Textures/CustomEditorImage2.png", typeof(Texture2D));
        #else
        Texture2D imageInspector = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Project/External/AllIn1SpriteShader/Textures/CustomEditorImage.png", typeof(Texture2D));
        #endif
