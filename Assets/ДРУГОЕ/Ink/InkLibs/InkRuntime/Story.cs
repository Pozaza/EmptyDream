...
namespace Ink.Runtime {
	...
	public class Story : Object {
		...
		public void SwitchFlow(string flowName) {
			...
			if (_asyncSaving)
				throw new System.Exception("Story is already in background saving mode, can't switch flow to " + flowName);
		...
		public StoryState CopyStateForBackgroundThreadSave() {
			...
			if (_asyncSaving)
				throw new System.Exception("Story is already in background saving mode, can't call CopyStateForBackgroundThreadSave again!");
