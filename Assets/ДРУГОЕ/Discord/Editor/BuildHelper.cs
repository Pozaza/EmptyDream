...
public class ScriptBatch
{
    ...
    public static void EnsureDLL()
    {
        ...
        foreach (string dirname in dstDirs) Directory.CreateDirectory(dirname);

        // copy dlls
        for (int i = 0; i < dstDlls.Length; i++) FileUtil.CopyFileOrDirectory(srcDlls[i], dstDlls[i]); ;
    }
}
