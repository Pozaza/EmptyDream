...
namespace Unified.Universal.Blur {
    class UniversalBlurPass : ScriptableRenderPass {
        ...
        private static readonly int m_KawaseOffsetID = Shader.PropertyToID("_KawaseOffset"), m_globalFullScreenBlurTexture = Shader.PropertyToID("_GlobalFullScreenBlurTexture");
